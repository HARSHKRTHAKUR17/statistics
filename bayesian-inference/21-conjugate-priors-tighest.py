...
# Generate 1000 random coin flips (1 for heads, 0 for tails)
...
def update(frame):
    ...
    if frame > 0:
        ...
        alpha_prior += heads  # Add heads to alpha
        beta_prior += tails   # Add tails to beta
    ...
    # Update the line for the Beta distribution
    # (density plot)
    density = beta.pdf(
        theta_range,
        alpha_prior,
...
# including the initial prior frame
# and updating every 10 flips
